...
filmes = [
    ...
    new Filme("monstros SA", 150, 7, false, false),
];
    ...
    document.getElementById("listaFilmes").innerHTML = listaFilmes
        .map(
            (filme) =>
                `<div class="cardFilme">
        <div class="favoritos">
            <img src="${filme.favorito
                    ? "src/imagens/favorito/favorito.png"
                    : "src/imagens/favorito/noFavorito.png"
                }" alt="">
        </div>
...
function adicionarFavorito() {
    ...
    const novoFilme = buscarFilme(filmes,this.parentNode.querySelector("#idFilme").innerHTML);
